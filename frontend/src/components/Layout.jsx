...
function Layout({ onLogout, user }) {
  ...
  //to fetch transcation from server
  ...
  return (
    <div className={styles.layout.root}>
      ...
      <Siderbar user={user} isCollapsed={sidebarCollapsed} setIsCollapsed={setSidebarCollapsed} onLogout={onLogout} />
      <div className={styles.layout.mainContainer(sidebarCollapsed)}>
        ...
        <div className={styles.statCards.grid}>
          ...
          <div className={styles.statCards.card}>
            ...
            <p className={styles.statCards.cardFooter}>
              <span
                className={`${styles.colors.expenseChange(stats.expenseChange)
                  } font-medium`}
              >
        ...
        <div className={styles.grid.main}>
            ...
            <div className={styles.cards.base}>
              ...
              <div className={styles.transactions.listContainer}>
                {displayedTransactions.map((transaction) => {
                  ...
                  return (
                    <div key={id} className={styles.transactions.transcationItem}>
                      <div className="flex items-center gap-1 md:gap-4 lg:gap-3">
                        ...
                        <div className={styles.transactions.transcationDetails}>
          ...
          <div className={styles.cards.base}>
            ...
            <div className={styles.categories.categoryItem}>

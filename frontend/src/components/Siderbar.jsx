...
import { HelpCircle, LogOut, Home, ArrowUp, ArrowDown, User, X, Menu } from 'lucide-react';
...
const Siderbar = ({ user, isCollapsed, setIsCollapsed, onLogout }) => {
...
const {name: userName="User", email: userEmail="user@example.com"} = user || {};

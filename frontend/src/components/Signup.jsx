...
export const Signup = ({API_URL = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? "http://localhost:4000" : "https://expense-tracker-online-k6kc.onrender.com"), onSignup}) => {
            ...
            <div className={signupStyles.header}>
                ...
                <h1 className={signupStyles.headerTitle}>
                    ...
                    <p className={signupStyles.headerSubtitle}>
                        Join Expense Tracker to manage your financial 
                    ...
                    <div className="mb-6">
                     ...
                     <div className="mb-6">
                        ...
                        <div className={signupStyles.inputContainer}>
                            ...
                            className={`${signupStyles.input} ${
                                errors.email?"border-red-300":"border-grey-200"
                     ...
                     <div className="mb-6">
                        ...
                        <div className={signupStyles.inputContainer}>
                            ...
                            className={`${signupStyles.passwordInput} ${
                                errors.password?"border-red-300":"border-grey-200"

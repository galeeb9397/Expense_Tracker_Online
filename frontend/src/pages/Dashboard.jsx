...
const { 
  ...
  // Always use live context data — updates immediately on add/delete
  ...
  const financialOverviewData = useMemo(() => {
    // Always compute from live context transactions — ensures immediate update on add/delete
    const categories = {};
    ...
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.gaugeGrid}>
        {gaugeData.map((gauge)=>(
          ...
          timFrameLabel={timeFrameRange.label}
          />
        ))

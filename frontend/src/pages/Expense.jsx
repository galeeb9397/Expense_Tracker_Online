...
const ExpensePage = () => {
  ...
  // Fetch overview whenever timeframe, filter, selectedMonth, or transactions change
  useEffect(() => {
    if (filter === "month" && !timeFrame) setTimeFrame("monthly");
    fetchOverview(timeFrame);
  }, [timeFrame, selectedMonth, filter, setTimeFrame, fetchOverview, outletTransactions]);

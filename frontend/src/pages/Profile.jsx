...
useEffect(()=>{
  ...
  const handleSaveProfile=async()=>{
    try {
        ...
        toast.error(err.response?.data?.message || "faliled to update profile");
    }
  };
...
const handlePasswordSubmit=async(e)=>{
    ...
    try {
        ...
        toast.error(error.response?.data?.message || "faliled to change password");
    }
};
                    ...
                    {editMode ?(
                        <div className="space-y-4">
                            <div> 
                                ...
                                <input 
                                type="text" name="name" value={tempUser.name}
                            ...
                            <div> 
                                ...
                                <input 
                                type="email" name="email" value={tempUser.email}
                                onChange={handleInputChange} className={profileStyles.input}
                                disabled={loading}
                                />
                            </div>
